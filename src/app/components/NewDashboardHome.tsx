        ...
        <motion.div variants={itemVariants} className="grid grid-cols-4 gap-4">
          {statsCards.map((stat, i) => (
            <motion.div
              ...
              className="group relative p-6 bg-white/5 border border-white/10 rounded-xl overflow-hidden cursor-default"
            >
              <div
                className={cn(
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="text-left py-3 px-6 text-xs font-medium text-gray-400 uppercase tracking-wider">Last Deploy</th>
                  <th className="text-left py-3 px-6 text-xs font-medium text-gray-400 uppercase tracking-wider">Visits</th>
                    ...
                    >
                      <td className="py-4 px-6">
                        ...
                        >
                          ...
                          <div>
                            <div className="font-medium text-white group-hover/cursor:text-violet-400 transition-colors">
